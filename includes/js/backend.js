...
jQuery(document).ready(function () {
    ...
    jQuery('ul.wc_pbp_addons_category li a:first').addClass('current');
    ...
    jQuery('ul.wc_pbp_addons_category li a').click(function () {
        ...
        jQuery('ul.wc_pbp_addons_category li a').removeClass('current');
        jQuery(this).addClass('current');
    ...
    jQuery('div.addons-search-form input.wp-filter-search').keyup(function () {
        ...
        if (val == '') {
            jQuery('.wc_pbp_addon_listing').html(html_source);
...
function wc_pbp_active_deactive_addon(ref, oppo) {
    ...
    jQuery.ajax({
        ...
        jQuery.ajax({
            method: 'GET',
            url: ajaxurl + '?action=wc_pbp_get_addons_html',
        }).done(function (response) {
