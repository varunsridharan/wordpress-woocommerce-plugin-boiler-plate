...
class WooCommerce_Plugin_Boiler_Plate_Admin_Options {
    ...
    private function add_settings_pages(){
        global $pages;
        $pages =  array();
        include(PLUGIN_ADMIN.'settings/pages.php');
    ...
    private function add_settings_section(){
        global $section;
        $section =  array();
        include(PLUGIN_ADMIN.'settings/section.php');
            ...
            if(is_array($s)){
                ...
                while($a < $c){
                    if(isset($s[$a]['validate_callback'])){
                        ...
                        $file = addslashes(PLUGIN_ADMIN.'settings/validate-'.$s[$a]['id'].'.php');
    ...
    private function add_settings_fields(){
        global $fields;
        $fields =  array();
        include(PLUGIN_ADMIN.'settings/fields.php');
